...
- Runtime contract 5 uses stable, versionless core artifact names; `migrate-artifact-names --granted-by user` adopts legacy names and fails closed on dual-name authority, while evidence-ledger v1 paths remain versioned.
