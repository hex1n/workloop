...
function runCriterionSource(source, repo, timeoutSeconds = CRITERION_TIMEOUT_SECONDS, protocol = "binary") {
  ...
  if (source.kind === "file") {
    ...
    result = shell
      ? spawnSync(command, { cwd: repo, encoding: "utf8", env: spawnEnv(), shell: true, timeout: timeoutSeconds * 1000, maxBuffer: 10 * 1024 * 1024 })
      : spawnSync(argv[0], argv.slice(1), { cwd: repo, encoding: "utf8", env: spawnEnv(), timeout: timeoutSeconds * 1000, maxBuffer: 10 * 1024 * 1024 });
