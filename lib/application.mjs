...
const OPTIONS = {
  ...
  "current-open": { target: OPTION, goal: OPTION, "write-path": { type: "string", multiple: true }, "write-root": { type: "string", multiple: true }, "command-id": OPTION, reason: OPTION, "granted-by": OPTION },
...
function cmdCurrentOpen(values) {
  return printCurrent(openCurrentGitTask({
    target: values.target, goal: values.goal, writePaths: values["write-path"], writeRoots: values["write-root"], commandId: values["command-id"],
